 ...
 <div class="flex">
   <div >
    ...
    >
        ...
        >
            ...
            >
               <img src="../assets/pet_logo.svg" alt="logo" class="h-10 w-10 text-amber-700 fill-current"/>  PetCare Admin
            </div>
            ...
            <div class="w-full flex items-center gap-x-1.5 group select-none">
                ...
                <div
                    ...
                    href="#"
                >
                    <routerLink to="/adminOrders" class="font-QuicksandMedium "
                        >Order</routerLink
                    >
                </div>
            </div>
            ...
            <div class="w-full flex items-center gap-x-1.5 group select-none">
                ...
                <div
                    ...
                    href="#"
                >
                    <router-link class="font-QuicksandMedium" to="/adminAppointment">Appointment</router-link>
                </div>
            </div>
        </div>
   ...
   <div class="flex-grow  h-screen  overflow-x-auto">
    ...
    >
      ...
      <button
        type="button"
        class="text-white  ml-4 focus:outline-none "
      >
    ...
    <nav :class="mobileMenuOpen ?'flex-col' :'hidden' ">
      <div class="w-full flex  items-center gap-x-1.5 group select-none">
            ...
            <div class="w-full flex flex-col items-center gap-x-1.5 group select-none">
